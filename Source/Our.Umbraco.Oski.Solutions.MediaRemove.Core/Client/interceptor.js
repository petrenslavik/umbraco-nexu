               ...
               'request': function (request) {
                   ...
                   if (Umbraco.Sys.ServerVariables.application.version) {
                       ...
                       if (request.url.indexOf("views/content/delete.html") === 0) {
                           request.url = '/App_Plugins/Oski.Solutions.MediaRemove/views/content-delete.html';
                       }

                       // Redirect any requests to built in media delete to our custom delete
                       if (request.url.indexOf("views/media/delete.html") === 0) {
                           request.url = '/App_Plugins/Oski.Solutions.MediaRemove/views/media-delete.html';
                       }
                       ...
                       if (request.url.indexOf("views/common/notifications/confirmunpublish.html") === 0) {
                           request.url = '/App_Plugins/Oski.Solutions.MediaRemove/views/confirmunpublish.html';
                       }
                       ...
                       if (version.major >= 7 && version.minor < 12) {
                           ...
                           if (unpublishUrlRegex.test(request.url)) {
                               ...
                               // get nexuResource
                               var nexuService = $injector.get('Our.Umbraco.Oski.Solutions.MediaRemove.Resource');
                                   ...
                                   .then(function(result) {
                                       ...
                                       if (result.data.length > 0) {
                                           notificationsService.add({
                                               ...
                                               view: "/App_Plugins/Oski.Solutions.MediaRemove/views/unpublish-confirmation.html",
